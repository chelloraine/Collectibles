...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($error_message)) {
        ...
        $check_stmt = $conn->prepare("SELECT id FROM Customers WHERE Username = ? OR Customer = ?");
        ...
        if ($check_stmt->num_rows > 0) {
            ...
            $stmt = $conn->prepare("INSERT INTO Customers (First_Name, Last_Name, username, Customer_Email, Contact_Number, birthday, password) VALUES (?, ?, ?, ?, ?, ?, ?)");
