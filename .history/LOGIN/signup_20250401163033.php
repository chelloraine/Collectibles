...
<body>
    <div class="login-container">
        ...
        <form action="signup.php" method="POST">
            ...
            <input type="Customer_Email" id="Customer_Email" name="Customer_Email" required placeholder="Enter your email"
                   title="Enter a valid email (e.g., user@example.com)">

            <label for="Contact_Number">Contact Number</label>
            <input type="tel" id="Contact_Number" name="contact" required placeholder="Enter your contact number" pattern="^(09|\+639)\d{9}$" title="Enter a valid Philippine phone number (e.g., 09171234567 or +639171234567)">

            <label for="birthday">Birthday</label>
            <input type="date" id="Date_Of_Birth" name="birthday" required>
