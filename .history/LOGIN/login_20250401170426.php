...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows == 1) {
        ...
        if (password_verify($password, $row['Admin_Password'])) {
            ...
            // Redirect to admin dashboard (change this as per your requirement)
        ...
        if ($result->num_rows == 1) {
            ...
            if (password_verify($password, $row['Password'])) {
                ...
                // Redirect to customer dashboard (change this as per your requirement)
                header("Location: http://localhost/website/USERPAGE/userpage.php"); 
                exit;
            } else {
